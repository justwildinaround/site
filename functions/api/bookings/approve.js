...
export async function onRequestGet({ request, env }) {
  ...
  // This should match your payment info page filename.
  // If yours is payment.html (or payments.html), adjust here.
  const paymentInfoUrl = `${baseUrl}/payments.html?bookingId=${encodeURIComponent(
    booking.id
